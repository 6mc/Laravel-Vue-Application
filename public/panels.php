...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="isveren.php"><em class="fa fa-plus">&nbsp;</em> İşyeri Ekle</a></li>
			
			<li class="active"><a href="panels.php"><em class="fa fa-clone">&nbsp;</em>Teşvik Analizi</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<select class="form-control">
											<option>Netadım Bilişim</option>
											<option selected="selected">AYB Teknoloji</option>
										</select>
			</div>
		</div><!--/.row-->
				<button type="submit" style="background-color: #3b3b3b;" class="btn btn-primary" onclick="success();" style="b">Teşvik Analizi Yap</button>
		<div class="row">
