...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li class="active"><a href="Kullanıcı.php"><em class="fa fa-plus">&nbsp;</em> Kullanıcı Ekle</a></li>
			<li><a href="isveren.php"><em class="fa fa-plus">&nbsp;</em> İşyeri Ekle</a></li>
			
			<li><a href="panels.php"><em class="fa fa-clone">&nbsp;</em>Teşvik Analizi</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Kayıtlı Kullanıcıler</h1>
			</div>
		</div><!--/.row-->
